...
import profil from "../assets/igadi.png";
      ...
      <div className="container px-4 mx-auto overflow-hidden">
        <div className="grid items-center grid-cols-1 pt-32 hero md:grid-cols-2">
          <div className="box">
            ...
            >
              A Frontend developer based in Indonesia, Adi Wijaya now 23 years
              old. I have worked on a wide range of Full Stack dev projects,
              from Petani Pintar applications android to Mobile Calculator Ios,
              with a focus on creating clean, well-crafted interfaces that not
          ...
          >
            <img
              src={HeroImage}
              alt="Hero"
              className="md:w-full w-[400px] mx-auto md:m-0 animate-bounce"
            />
          </motion.div>
        </div>
        <div
            ...
            >
              <li class="mb-10 ms-4">
                ...
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                  Graduate of Yogyakarta University of Technology
                </h3>
                <p class="mb-4 text-base text-justify font-normal text-gray-500 dark:text-gray-400">
                  I was able to graduate on time in 3.5 years and my final
                  project was to create a smart farmer application to control
                  the nutrition of android-based hydroponic plants using the
                  java programming language, the software used is android
                  studio.
                </p>
              </li>
              <li class="mb-10 ms-4">
                ...
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                  Application & Webset Development Services Freelancer
                </h3>
                <p class="text-base text-justify font-normal text-gray-500 dark:text-gray-400">
                  Ios Calculator App Creation, developed using HTML, Javascript
                  and CSS languages. Personal Webset, developed using express.js
                  and handlebars languages.
                </p>
              </li>
              <li class="ms-4">
                <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                ...
                <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                  providing technical support, troubleshooting hardware,
                  software, and network issues, and installing and maintaining
                  IT systems to ensure users can work smoothly.
                </p>
              </li>
            </motion.ol>
          </div>
          ...
          <div className="grid grid-cols-1 gap-6 pt-12 proyek-box lg:grid-cols-3 md:grid-cols-2">
            <div class="rounded p-2  bg-white shadow group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30">
              ...
              <div class="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
                ...
                <p class="mb-5 text-lg italic text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                  Controlling Nutrient Needs in Android-Based Hydroponic Plants
                  Smart Hidroponic
                </p>
                <a href="https://github.com/AdiWijaya5/Aplikasi-Pengendali-Kebutuhan-Nutrisi-Pada-Tanaman-Hidroponik-Berbasis-android.git">
            ...
            <div class="rounded p-2  bg-white shadow group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30">
              ...
              <div class="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
                <h1 class="font-dmserif text-3xl font-bold text-white">
                  Mobile Calculator Ios
                </h1>
                <p class="mb-5 text-lg italic text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                  {" "}
                  iPhone Calculator using only HTML, CSS, and JavaScript
                </p>
            ...
            <div class="rounded p-2  bg-white shadow group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30">
              ...
              <div class="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
                ...
                <p class="mb-5 text-lg italic text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                  Fotografi Ade Stiyawan framework React.js and Talwind CSS
                </p>
                <a href="https://traveldocid.vercel.app/">
                  <button class="rounded-full bg-neutral-900 py-2 px-3.5 font-com text-sm capitalize text-white shadow shadow-black/60">
                    See More
                  </button>
                </a>
